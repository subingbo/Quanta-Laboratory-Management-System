...
public final class QtAuthUtils
{
    ...
    public static final String PERM_ACTIVITY_LIST = "system:activity:list";
    public static final String PERM_SIGNUP_LIST = "system:signup:list";
    public static final String PERM_BORROW_LIST = "system:borrow:list";
    public static final String PERM_RESERVATION_LIST = "system:reservation:list";
    public static final String PERM_ORDER_LIST = "system:order:list";
