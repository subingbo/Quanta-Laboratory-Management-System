...
<template>
  <ElDialog v-model="visible" width="620" class="quanta-dialog notice-dialog" destroy-on-close>
    ...
    <div v-loading="loading" class="notice-dialog__body">
      ...
      <ElInput :model-value="preview.content || ''" type="textarea" :rows="7" readonly aria-label="邮件模板" />
      <label v-if="requiresQr" class="notice-dialog__upload"><span>群二维码附件</span><input type="file" accept=".jpg,.jpeg,.png,image/jpeg,image/png" @change="selectFile"><small>支持 JPG、JPEG、PNG，最大 5 MB</small></label>
