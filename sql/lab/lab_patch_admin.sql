...
(4006, '活动管理', 4000, 6, 'activity', 'qt/activity/index', '', '', 1, 0, 'C', '0', '0', 'system:activity:list', 'date', 'admin', NOW(), '', NULL, '活动维护'),
(4007, '图书管理', 4000, 7, 'book', 'qt/book/index', '', '', 1, 0, 'C', '0', '0', 'system:book:list', 'education', 'admin', NOW(), '', NULL, '图书维护'),
(4008, '工位管理', 4000, 8, 'workstation', 'qt/workstation/index', '', '', 1, 0, 'C', '0', '0', 'system:workstation:list', 'tree', 'admin', NOW(), '', NULL, '工位维护'),
(4009, '塔服款式', 4000, 9, 'item', 'qt/item/index', '', '', 1, 0, 'C', '0', '0', 'system:item:list', 'shopping', 'admin', NOW(), '', NULL, '服装款式'),
(4014, '塔服订单', 4000, 10, 'order', 'qt/order/index', '', '', 1, 0, 'C', '0', '0', 'system:order:list', 'money', 'admin', NOW(), '', NULL, '服装订单'),
(4015, '付款码配置', 4000, 11, 'payment-config', 'qt/payment/index', '', '', 1, 0, 'C', '0', '0', 'system:payment-config:list', 'qrcode', 'admin', NOW(), '', NULL, '付款码'),
(4016, '借阅记录', 4000, 12, 'borrow', 'qt/borrow/index', '', '', 1, 0, 'C', '0', '0', 'system:borrow:list', 'log', 'admin', NOW(), '', NULL, '借阅'),
(4017, '预约记录', 4000, 13, 'reservation', 'qt/reservation/index', '', '', 1, 0, 'C', '0', '0', 'system:reservation:list', 'time', 'admin', NOW(), '', NULL, '工位预约'),
(4018, '报名记录', 4000, 14, 'signup', 'qt/signup/index', '', '', 1, 0, 'C', '0', '0', 'system:signup:list', 'form', 'admin', NOW(), '', NULL, '活动报名'),
...
(4040, '活动新增', 4006, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:activity:add', '#', 'admin', NOW(), '', NULL, ''),
(4041, '活动修改', 4006, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:activity:edit', '#', 'admin', NOW(), '', NULL, ''),
(4042, '活动删除', 4006, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:activity:remove', '#', 'admin', NOW(), '', NULL, ''),
(4043, '活动导出', 4006, 4, '', '', '', '', 1, 0, 'F', '0', '0', 'system:activity:export', '#', 'admin', NOW(), '', NULL, ''),
(4050, '图书新增', 4007, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:book:add', '#', 'admin', NOW(), '', NULL, ''),
(4051, '图书修改', 4007, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:book:edit', '#', 'admin', NOW(), '', NULL, ''),
(4052, '图书删除', 4007, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:book:remove', '#', 'admin', NOW(), '', NULL, ''),
(4053, '图书导出', 4007, 4, '', '', '', '', 1, 0, 'F', '0', '0', 'system:book:export', '#', 'admin', NOW(), '', NULL, ''),
(4060, '工位新增', 4008, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:workstation:add', '#', 'admin', NOW(), '', NULL, ''),
(4061, '工位修改', 4008, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:workstation:edit', '#', 'admin', NOW(), '', NULL, ''),
(4062, '工位删除', 4008, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:workstation:remove', '#', 'admin', NOW(), '', NULL, ''),
(4070, '款式新增', 4009, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:item:add', '#', 'admin', NOW(), '', NULL, ''),
(4071, '款式修改', 4009, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:item:edit', '#', 'admin', NOW(), '', NULL, ''),
(4072, '款式删除', 4009, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:item:remove', '#', 'admin', NOW(), '', NULL, ''),
(4080, '确认收款', 4014, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:order:approve', '#', 'admin', NOW(), '', NULL, ''),
(4081, '订单修改', 4014, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:order:edit', '#', 'admin', NOW(), '', NULL, ''),
(4082, '订单删除', 4014, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:order:remove', '#', 'admin', NOW(), '', NULL, ''),
(4083, '订单导出', 4014, 4, '', '', '', '', 1, 0, 'F', '0', '0', 'system:order:export', '#', 'admin', NOW(), '', NULL, ''),
(4090, '付款码新增', 4015, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:payment-config:add', '#', 'admin', NOW(), '', NULL, ''),
(4091, '付款码修改', 4015, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:payment-config:edit', '#', 'admin', NOW(), '', NULL, ''),
(4092, '付款码删除', 4015, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:payment-config:remove', '#', 'admin', NOW(), '', NULL, ''),
(4100, '借阅修改', 4016, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:borrow:edit', '#', 'admin', NOW(), '', NULL, ''),
(4101, '借阅删除', 4016, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:borrow:remove', '#', 'admin', NOW(), '', NULL, ''),
(4102, '借阅导出', 4016, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:borrow:export', '#', 'admin', NOW(), '', NULL, ''),
(4110, '预约修改', 4017, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:reservation:edit', '#', 'admin', NOW(), '', NULL, ''),
(4111, '预约删除', 4017, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:reservation:remove', '#', 'admin', NOW(), '', NULL, ''),
(4112, '预约导出', 4017, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:reservation:export', '#', 'admin', NOW(), '', NULL, ''),
(4120, '报名修改', 4018, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:signup:edit', '#', 'admin', NOW(), '', NULL, ''),
(4121, '报名删除', 4018, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:signup:remove', '#', 'admin', NOW(), '', NULL, ''),
(4122, '报名导出', 4018, 3, '', '', '', '', 1, 0, 'F', '0', '0', 'system:signup:export', '#', 'admin', NOW(), '', NULL, '');
