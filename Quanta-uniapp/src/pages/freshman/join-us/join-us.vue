<template>
	<view class="join-us-page">
		...
		<view class="tab-content" :class="{ 'tab-content--process': activeTab === 'process' }"><Process v-if="activeTab === 'process'" @go-submit="switchTab('submit')" /><Submit v-else ref="submitRef" /></view>
	</view>
</template>
